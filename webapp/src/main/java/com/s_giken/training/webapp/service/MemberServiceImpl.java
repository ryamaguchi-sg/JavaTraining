...
public class MemberServiceImpl implements MemberService {
	...
	public List<Member> findByConditions(MemberSearchCondition memberSearchCondition) {
		...
		// 並び替え項目と順序の取得
		String sortKey = memberSearchCondition.getSortKey();
		String orderDirection = memberSearchCondition.getOrderDirection();

		return memberRepository.findByMailAndNameSorted(mail, name, sortKey, orderDirection);
	}
